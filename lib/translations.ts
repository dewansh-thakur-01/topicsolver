...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'quiz.swapQuestion': '🔄 Try New Question on this Topic',
    'quiz.swappedNotice': 'Question changed! Here is a new question for this topic.',
  ...
  ta: {
    ...
    'quiz.swapQuestion': '🔄 இந்த தலைப்பில் புதிய கேள்வியை முயற்சிக்கவும்',
    'quiz.swappedNotice': 'கேள்வி மாற்றப்பட்டது! இந்த தலைப்பிற்கு புதிய கேள்வி இதோ.',
  ...
  te: {
    ...
    'quiz.swapQuestion': '🔄 ఈ అంశంపై కొత్త ప్రశ్నను ప్రయత్నించండి',
    'quiz.swappedNotice': 'ప్రశ్న మార్చబడింది! ఈ అంశం కోసం కొత్త ప్రశ్న ఇక్కడ ఉంది.',
  ...
  ml: {
    ...
    'quiz.swapQuestion': '🔄 ഈ വിഷയത്തിൽ പുതിയ ചോദ്യം പരീക്ഷിക്കുക',
    'quiz.swappedNotice': 'ചോദ്യം മാറ്റി! ഈ വിഷയത്തിനായി പുതിയ ചോദ്യം ഇതാ.',
  ...
  hi: {
    ...
    'quiz.swapQuestion': '🔄 इस विषय पर नया प्रश्न आज़माएँ',
    'quiz.swappedNotice': 'प्रश्न बदल दिया गया! इस विषय के लिए एक नया प्रश्न यहाँ है।',
