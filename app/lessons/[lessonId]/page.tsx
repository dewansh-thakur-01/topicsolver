          ...
          <div className="space-y-3 pt-4 border-t border-[#DCE5F2] dark:border-[#222B3D]">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-[#16191D] flex items-center gap-1.5 dark:text-white">
                <Video className="h-4 w-4 text-[#2B6FF3]" />
              ...
              <div className="rounded-2xl border border-[#DCE5F2] bg-[#F7F9FC] p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 dark:bg-[#0E121C] dark:border-[#222B3D]">
                <div className="space-y-1">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs font-bold text-[#16191D] dark:text-white">YouTube Video Lesson Available</span>
                  </div>
                  <p className="text-[11px] text-[#687385] dark:text-[#94A3B8]">
                    Watch the official step-by-step video tutorial for "{foundTopic.title}".
                  </p>
                </div>
                <a
                  ...
                  className="inline-flex items-center justify-center space-x-2 rounded-xl bg-rose-600 hover:bg-rose-500 text-white px-4 py-2 text-xs font-bold shadow-md shadow-rose-600/25 transition-all shrink-0"
                >
